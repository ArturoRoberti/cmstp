...
from cstp.utils.common import generate_random_path, resolve_package_path
from cstp.utils.git_repos import clone_git_files, is_git_repo
from cstp.utils.system_info import get_system_info
...
class MainSetupProcessor:
    ...
    def process_args(self) -> Tuple[MainSetupArgs, Optional[Path]]:
        ...
        if is_git_repo(str(self.args.config_directory)):
            # Git repo
            cloned_config_dir = generate_random_path(prefix="cstp_config_dir_")
